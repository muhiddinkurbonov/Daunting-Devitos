          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-shrink-0">
              <div className="w-40 h-40 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg flex items-center justify-center shadow-lg border-2 border-yellow-700">
                <svg
                  className="w-20 h-20 text-black/50"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <div className="flex-grow">
              <h1 className="text-4xl font-bold bg-gradient-to-b from-yellow-400 via-yellow-500 to-yellow-600 bg-clip-text text-transparent mb-2">{playerName}</h1>
              <p className="text-gray-300 mb-4">Player ID: <span className="text-yellow-400 font-semibold">{id}</span></p>
